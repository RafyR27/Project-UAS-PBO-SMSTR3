 ...
 * @author Rafy1
 */
public class AdminTransaksiCardDikirim extends javax.swing.JPanel {
    ...
    public AdminTransaksiCardDikirim() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        buttonSelesai.setBackground(new java.awt.Color(0, 101, 248));
        buttonSelesai.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        buttonSelesai.setForeground(new java.awt.Color(255, 255, 255));
        buttonSelesai.setText("Selesai");
        buttonSelesai.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(buttonSelesai, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jLabel13, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(lbTotal_price, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(4, 4, 4)))
                .addGap(14, 14, 14))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(14, 14, 14)
                .addComponent(containerProduct, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel13)
                    .addComponent(lbTotal_price))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(buttonSelesai, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(21, 21, 21))
        );
    ...
    private void buttonSelesaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSelesaiActionPerformed
        int result = adminServices.updateOrderStatus(order_id);
        
        if(result == 200){
            JOptionPane.showMessageDialog(SwingUtilities.getWindowAncestor(this), "Status pesanan telah berubah!");
            MainFrame main = (MainFrame) SwingUtilities.windowForComponent(this);
            main.showAdminTransactionPage("admin");
        } else if(result == 404){
            JOptionPane.showMessageDialog(SwingUtilities.getWindowAncestor(this), "Pesanan tidak ditemukan!");
        } else if(result == 500){
